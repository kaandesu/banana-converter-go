...
FROM golang:1.19@sha256:dc76ef03e54c34a00dcdca81e55c242d24b34d231637776c4bb5c1a8e8514253 AS base
ENV GO111MODULE=on
ENV CGO_ENABLED=0
ENV GOOS=linux
ENV GOARCH=amd64
...
RUN --mount=target=. \
    ...
    go build -ldflags="-w -s" -o /app/main ./cmd/banana-converter-go/*.go
